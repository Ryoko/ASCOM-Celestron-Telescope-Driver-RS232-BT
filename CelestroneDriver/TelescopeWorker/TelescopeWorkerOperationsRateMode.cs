namespace CelestroneDriver.TelescopeWorker
{
    ...
    class TelescopeWorkerOperationsNaturalMode : ITelescopeWorkerOperations
    {
        ...
        {
            if (this.tp.IsRateTracked || this.ti == null || !this.ti.CanSlewHighRate || !this.ti.CanSetTracking) return;
        ...
        {
            if (this.ti != null && this.tp != null && this.tp.IsRateTracked && !this.tp.IsAtPark)
            {
